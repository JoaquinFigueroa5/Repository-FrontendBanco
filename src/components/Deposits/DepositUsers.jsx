...
const DepositUsers = ({ onSuccess }) => {
  ...
  const isFormValid = amount && !isNaN(amount) && parseFloat(amount) > 0
      ...
      <MotionVStack spacing={6} align='stretch'>
        ...
        >
          ...
          <Text
            ...
            lineHeight="1.6"
          >
            Realiza depósitos directamente a tu cuenta personal
          </Text>
        ...
        <MotionBox variants={itemVariants} pt={4}>
          ...
          >
            {isFetching ? 'Procesando Depósito...' : 'Depositar'}
          </MotionButton>
        </MotionBox>
          ...
          <HStack spacing={3}>
            ...
            <VStack align="start" spacing={1}>
              ...
              <Text
                ...
                lineHeight="1.4"
              >
                El depósito se realizará directamente a tu cuenta personal de forma segura
              </Text>
            </VStack>
          </HStack>
        </MotionBox>
